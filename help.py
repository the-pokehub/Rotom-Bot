...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        help_embed.add_field(name="📛Badge System", value=f"`{prefix}help badge`", inline=False)

        help_embed.add_field(name="🎴 Pokedex", value=f"`{prefix}help pokedex`", inline=False)
        ...
        help_embed.set_footer(text=f"Use {prefix}prefix [new_prefix] to change Bot's Prefix.")
    ...
    async def music(self, ctx):
        ...
        help_embed.add_field(name="Join", value="Summons the bot to a voice channel. If no channel was specified, it joins your channel.")

        help_embed.add_field(name="Leave", value="Clears the queue and leaves the voice channel.")

        help_embed.add_field(name="Play", value="Plays a song. If there are songs in the queue, this will be queued until the other songs finished playing.")
        ...
        help_embed.add_field(name="Skip", value="Vote to skip a song. The requester can automatically skip. 3 skip votes are needed for the song to be skipped.")

        help_embed.add_field(name="Queue", value="Shows the player's queue. You can optionally specify the page to show. Each page contains 10 elements.")
        ...
        help_embed.add_field(name="Loop", value="Loops the currently playing song. Use this command again to unloop the song.")
    ...
    async def misc(self, ctx):
        ...
        help_embed.add_field(name="serverinfo", value="Get some informations about the server.")

        help_embed.add_field(name="say", value="Make Bot say something for you. `Bot needs manage_messages and manage_webhooks permission for this.`")
    ...
    async def fun(self, ctx):
        ...
        help_embed.add_field(name=f"{prefix}8Pool",
                    value="Play 8Pool. See your Fortune or take advice.", inline=True)
